...
#import "TogetterViewController.h"
#import "TogetterDetailViewController.h"
#import "SSGentleAlertView.h"
#import "SSDialogView.h"

@interface TogetterViewController () {
...
@implementation TogetterViewController
- (void)viewDidLoad
{
    [super viewDidLoad];
    ...
    self.navigationItem.title = @"注目togetter";
...
{
    static NSString *CellIdentifier = @"TogetterCell";
...
{
    if ([[segue identifier] isEqualToString:@"showTogetterDetail"]) {
        NSLog(@"showTogetterDetail");
        NSIndexPath *indexPath = [self.tableView indexPathForSelectedRow];
        Item *item = _items[indexPath.row];
        
        TogetterDetailViewController *togetterDetailViewController = [segue destinationViewController];
        [[segue destinationViewController] setDetailItem:item];
        togetterDetailViewController.linkurl = item.linkurl;
...
- (void)startDownload{
    ...
    NSString * feed = @"http://togetter.com/rss/index";
